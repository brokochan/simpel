...
?>
<?php if ($user_list->id_user->Visible) { // id_user ?>
	<?php if ($user_list->SortUrl($user_list->id_user) == "") { ?>
		<th data-name="id_user" class="<?php echo $user_list->id_user->headerCellClass() ?>"><div id="elh_user_id_user" class="user_id_user"><div class="ew-table-header-caption"><?php echo $user_list->id_user->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id_user" class="<?php echo $user_list->id_user->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $user_list->SortUrl($user_list->id_user) ?>', 1);"><div id="elh_user_id_user" class="user_id_user">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $user_list->id_user->caption() ?></span><span class="ew-table-header-sort"><?php if ($user_list->id_user->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($user_list->id_user->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($user_list->nama_lengkap->Visible) { // nama_lengkap ?>
	<?php if ($user_list->SortUrl($user_list->nama_lengkap) == "") { ?>
		<th data-name="nama_lengkap" class="<?php echo $user_list->nama_lengkap->headerCellClass() ?>"><div id="elh_user_nama_lengkap" class="user_nama_lengkap"><div class="ew-table-header-caption"><?php echo $user_list->nama_lengkap->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="nama_lengkap" class="<?php echo $user_list->nama_lengkap->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $user_list->SortUrl($user_list->nama_lengkap) ?>', 1);"><div id="elh_user_nama_lengkap" class="user_nama_lengkap">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $user_list->nama_lengkap->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($user_list->nama_lengkap->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($user_list->nama_lengkap->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($user_list->username->Visible) { // username ?>
	...
	<?php } else { ?>
		<th data-name="username" class="<?php echo $user_list->username->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $user_list->SortUrl($user_list->username) ?>', 1);"><div id="elh_user_username" class="user_username">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $user_list->username->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($user_list->username->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($user_list->username->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($user_list->password->Visible) { // password ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($user_list->_email->Visible) { // email ?>
	<?php if ($user_list->SortUrl($user_list->_email) == "") { ?>
		<th data-name="_email" class="<?php echo $user_list->_email->headerCellClass() ?>"><div id="elh_user__email" class="user__email"><div class="ew-table-header-caption"><?php echo $user_list->_email->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="_email" class="<?php echo $user_list->_email->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $user_list->SortUrl($user_list->_email) ?>', 1);"><div id="elh_user__email" class="user__email">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $user_list->_email->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($user_list->_email->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($user_list->_email->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($user_list->_userlevel->Visible) { // userlevel ?>
	<?php if ($user_list->SortUrl($user_list->_userlevel) == "") { ?>
		<th data-name="_userlevel" class="<?php echo $user_list->_userlevel->headerCellClass() ?>"><div id="elh_user__userlevel" class="user__userlevel"><div class="ew-table-header-caption"><?php echo $user_list->_userlevel->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="_userlevel" class="<?php echo $user_list->_userlevel->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $user_list->SortUrl($user_list->_userlevel) ?>', 1);"><div id="elh_user__userlevel" class="user__userlevel">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $user_list->_userlevel->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($user_list->_userlevel->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($user_list->_userlevel->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
?>
	<?php if ($user_list->id_user->Visible) { // id_user ?>
		<td data-name="id_user" <?php echo $user_list->id_user->cellAttributes() ?>>
<span id="el<?php echo $user_list->RowCount ?>_user_id_user">
<span<?php echo $user_list->id_user->viewAttributes() ?>><?php echo $user_list->id_user->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($user_list->nama_lengkap->Visible) { // nama_lengkap ?>
		<td data-name="nama_lengkap" <?php echo $user_list->nama_lengkap->cellAttributes() ?>>
<span id="el<?php echo $user_list->RowCount ?>_user_nama_lengkap">
<span<?php echo $user_list->nama_lengkap->viewAttributes() ?>><?php echo $user_list->nama_lengkap->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($user_list->username->Visible) { // username ?>
...
<span<?php echo $user_list->password->viewAttributes() ?>><?php echo $user_list->password->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($user_list->_email->Visible) { // email ?>
		<td data-name="_email" <?php echo $user_list->_email->cellAttributes() ?>>
<span id="el<?php echo $user_list->RowCount ?>_user__email">
<span<?php echo $user_list->_email->viewAttributes() ?>><?php echo $user_list->_email->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($user_list->_userlevel->Visible) { // userlevel ?>
		<td data-name="_userlevel" <?php echo $user_list->_userlevel->cellAttributes() ?>>
<span id="el<?php echo $user_list->RowCount ?>_user__userlevel">
<span<?php echo $user_list->_userlevel->viewAttributes() ?>><?php echo $user_list->_userlevel->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
