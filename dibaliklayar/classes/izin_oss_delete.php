 ...
 * Page class
 */
class izin_oss_delete extends izin_oss
{
	...
	// Page object name
	public $PageObjName = "izin_oss_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("izin_osslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("izin_osslist.php"); // Return to list
			}
		}
	}
