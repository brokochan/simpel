 ...
 * Page class
 */
class subsektor_view extends subsektor
{
	...
	// Page object name
	public $PageObjName = "subsektor_view";
	...
	public function __construct()
	{
		...
		if (Get("id_subsektor") !== NULL) {
			$this->RecKey["id_subsektor"] = Get("id_subsektor");
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_subsektor") !== NULL) {
				...
				$this->id_subsektor->setFormValue(Route(2));
				$this->RecKey["id_subsektor"] = $this->id_subsektor->FormValue;
			} else {
				$returnUrl = "subsektorlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "subsektorlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "subsektorlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
