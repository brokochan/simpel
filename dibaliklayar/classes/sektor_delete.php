 ...
 * Page class
 */
class sektor_delete extends sektor
{
	...
	// Page object name
	public $PageObjName = "sektor_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("sektorlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("sektorlist.php"); // Return to list
			}
		}
	}
