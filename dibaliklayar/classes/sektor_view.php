 ...
 * Page class
 */
class sektor_view extends sektor
{
	...
	// Page object name
	public $PageObjName = "sektor_view";
	...
	public function __construct()
	{
		...
		if (Get("id_sektor") !== NULL) {
			$this->RecKey["id_sektor"] = Get("id_sektor");
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_sektor") !== NULL) {
				...
				$this->id_sektor->setFormValue(Route(2));
				$this->RecKey["id_sektor"] = $this->id_sektor->FormValue;
			} else {
				$returnUrl = "sektorlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "sektorlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "sektorlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
