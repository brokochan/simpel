 ...
 * Page class
 */
class kecamatan_delete extends kecamatan
{
	...
	// Page object name
	public $PageObjName = "kecamatan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("kecamatanlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("kecamatanlist.php"); // Return to list
			}
		}
	}
