 ...
 * Page class
 */
class izin_oss_list extends izin_oss
{
	...
	// Page object name
	public $PageObjName = "izin_oss_list";

	// Grid form hidden field names
	public $FormName = "fizin_osslist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "izin_ossadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "izin_ossdelete.php";
		$this->MultiUpdateUrl = "izin_ossupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fizin_osslistsrch";
	...
	protected function setupKeyValues($key)
	{
		...
		if (count($arKeyFlds) >= 1) {
			$this->id_izin_oss->setOldValue($arKeyFlds[0]);
			if (!is_numeric($this->id_izin_oss->OldValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	public function getFilterList()
	{
		...
		$filterList = "";
		$savedFilterList = "";
		$filterList = Concat($filterList, $this->id_izin_oss->AdvancedSearch->toJson(), ","); // Field id_izin_oss
		$filterList = Concat($filterList, $this->NIB->AdvancedSearch->toJson(), ","); // Field NIB
		$filterList = Concat($filterList, $this->jenis_pelaku_usaha->AdvancedSearch->toJson(), ","); // Field jenis_pelaku_usaha
		$filterList = Concat($filterList, $this->nama_pelaku_usaha->AdvancedSearch->toJson(), ","); // Field nama_pelaku_usaha
		$filterList = Concat($filterList, $this->id_jbu->AdvancedSearch->toJson(), ","); // Field id_jbu
		$filterList = Concat($filterList, $this->id_pm->AdvancedSearch->toJson(), ","); // Field id_pm
		$filterList = Concat($filterList, $this->id_kecamatan->AdvancedSearch->toJson(), ","); // Field id_kecamatan
		$filterList = Concat($filterList, $this->kode_kbli->AdvancedSearch->toJson(), ","); // Field kode_kbli
		$filterList = Concat($filterList, $this->id_skala_usaha->AdvancedSearch->toJson(), ","); // Field id_skala_usaha
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fizin_osslistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field id_izin_oss
		$this->id_izin_oss->AdvancedSearch->SearchValue = @$filter["x_id_izin_oss"];
		$this->id_izin_oss->AdvancedSearch->SearchOperator = @$filter["z_id_izin_oss"];
		$this->id_izin_oss->AdvancedSearch->SearchCondition = @$filter["v_id_izin_oss"];
		$this->id_izin_oss->AdvancedSearch->SearchValue2 = @$filter["y_id_izin_oss"];
		$this->id_izin_oss->AdvancedSearch->SearchOperator2 = @$filter["w_id_izin_oss"];
		$this->id_izin_oss->AdvancedSearch->save();
		...
		// Field jenis_pelaku_usaha
		$this->jenis_pelaku_usaha->AdvancedSearch->SearchValue = @$filter["x_jenis_pelaku_usaha"];
		$this->jenis_pelaku_usaha->AdvancedSearch->SearchOperator = @$filter["z_jenis_pelaku_usaha"];
		$this->jenis_pelaku_usaha->AdvancedSearch->SearchCondition = @$filter["v_jenis_pelaku_usaha"];
		$this->jenis_pelaku_usaha->AdvancedSearch->SearchValue2 = @$filter["y_jenis_pelaku_usaha"];
		$this->jenis_pelaku_usaha->AdvancedSearch->SearchOperator2 = @$filter["w_jenis_pelaku_usaha"];
		$this->jenis_pelaku_usaha->AdvancedSearch->save();

		// Field nama_pelaku_usaha
		$this->nama_pelaku_usaha->AdvancedSearch->SearchValue = @$filter["x_nama_pelaku_usaha"];
		$this->nama_pelaku_usaha->AdvancedSearch->SearchOperator = @$filter["z_nama_pelaku_usaha"];
		$this->nama_pelaku_usaha->AdvancedSearch->SearchCondition = @$filter["v_nama_pelaku_usaha"];
		$this->nama_pelaku_usaha->AdvancedSearch->SearchValue2 = @$filter["y_nama_pelaku_usaha"];
		$this->nama_pelaku_usaha->AdvancedSearch->SearchOperator2 = @$filter["w_nama_pelaku_usaha"];
		$this->nama_pelaku_usaha->AdvancedSearch->save();
		...
		// Field id_pm
		$this->id_pm->AdvancedSearch->SearchValue = @$filter["x_id_pm"];
		$this->id_pm->AdvancedSearch->SearchOperator = @$filter["z_id_pm"];
		$this->id_pm->AdvancedSearch->SearchCondition = @$filter["v_id_pm"];
		$this->id_pm->AdvancedSearch->SearchValue2 = @$filter["y_id_pm"];
		$this->id_pm->AdvancedSearch->SearchOperator2 = @$filter["w_id_pm"];
		$this->id_pm->AdvancedSearch->save();
		...
		// Field kode_kbli
		$this->kode_kbli->AdvancedSearch->SearchValue = @$filter["x_kode_kbli"];
		$this->kode_kbli->AdvancedSearch->SearchOperator = @$filter["z_kode_kbli"];
		$this->kode_kbli->AdvancedSearch->SearchCondition = @$filter["v_kode_kbli"];
		$this->kode_kbli->AdvancedSearch->SearchValue2 = @$filter["y_kode_kbli"];
		$this->kode_kbli->AdvancedSearch->SearchOperator2 = @$filter["w_kode_kbli"];
		$this->kode_kbli->AdvancedSearch->save();

		// Field id_skala_usaha
		$this->id_skala_usaha->AdvancedSearch->SearchValue = @$filter["x_id_skala_usaha"];
		$this->id_skala_usaha->AdvancedSearch->SearchOperator = @$filter["z_id_skala_usaha"];
		$this->id_skala_usaha->AdvancedSearch->SearchCondition = @$filter["v_id_skala_usaha"];
		$this->id_skala_usaha->AdvancedSearch->SearchValue2 = @$filter["y_id_skala_usaha"];
		$this->id_skala_usaha->AdvancedSearch->SearchOperator2 = @$filter["w_id_skala_usaha"];
		$this->id_skala_usaha->AdvancedSearch->save();
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->jenis_pelaku_usaha, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->nama_pelaku_usaha, $arKeywords, $type);
		return $where;
	}
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->id_izin_oss); // id_izin_oss
			$this->updateSort($this->NIB); // NIB
			$this->updateSort($this->jenis_pelaku_usaha); // jenis_pelaku_usaha
			$this->updateSort($this->nama_pelaku_usaha); // nama_pelaku_usaha
			$this->updateSort($this->id_jbu); // id_jbu
			$this->updateSort($this->id_pm); // id_pm
			$this->updateSort($this->id_kecamatan); // id_kecamatan
			$this->updateSort($this->kode_kbli); // kode_kbli
			$this->updateSort($this->id_skala_usaha); // id_skala_usaha
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				$orderBy = "";
				$this->setSessionOrderBy($orderBy);
				$this->id_izin_oss->setSort("");
				$this->NIB->setSort("");
				$this->jenis_pelaku_usaha->setSort("");
				$this->nama_pelaku_usaha->setSort("");
				$this->id_jbu->setSort("");
				$this->id_pm->setSort("");
				$this->id_kecamatan->setSort("");
				$this->kode_kbli->setSort("");
				$this->id_skala_usaha->setSort("");
	...
	public function renderListOptions()
	{
		...
		$opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->id_izin_oss->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fizin_osslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fizin_osslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fizin_osslist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fizin_osslistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
