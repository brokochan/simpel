 ...
 * Page class
 */
class jenis_badan_usaha_add extends jenis_badan_usaha
{
	...
	// Page object name
	public $PageObjName = "jenis_badan_usaha_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_jbu") !== NULL) {
				...
				$this->setKey("id_jbu", $this->id_jbu->CurrentValue); // Set up key
			} else {
				$this->setKey("id_jbu", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "jenis_badan_usahaview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// jenis_perusahaan
		$this->jenis_perusahaan->setDbValueDef($rsnew, $this->jenis_perusahaan->CurrentValue, "", FALSE);
