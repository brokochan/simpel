...
class user extends DbTable
{
	...
	public function __construct()
	{
		...
		// id_user
		$this->id_user = new DbField('user', 'user', 'x_id_user', 'id_user', '`id_user`', '`id_user`', 3, 11, -1, FALSE, '`id_user`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nama_lengkap
		$this->nama_lengkap = new DbField('user', 'user', 'x_nama_lengkap', 'nama_lengkap', '`nama_lengkap`', '`nama_lengkap`', 200, 32, -1, FALSE, '`nama_lengkap`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// username
		$this->username = new DbField('user', 'user', 'x_username', 'username', '`username`', '`username`', 200, 32, -1, FALSE, '`username`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// email
		$this->_email = new DbField('user', 'user', 'x__email', 'email', '`email`', '`email`', 200, 32, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// userlevel
		$this->_userlevel = new DbField('user', 'user', 'x__userlevel', 'userlevel', '`userlevel`', '`userlevel`', 200, 32, -1, FALSE, '`userlevel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
