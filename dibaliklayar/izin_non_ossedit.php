...
loadjs.ready("head", function() {
	...
	fizin_non_ossedit.lists["x_id_jenis_izin"] = <?php echo $izin_non_oss_edit->id_jenis_izin->Lookup->toClientList($izin_non_oss_edit) ?>;
	fizin_non_ossedit.lists["x_id_jenis_izin"].options = <?php echo JsonEncode($izin_non_oss_edit->id_jenis_izin->lookupOptions()) ?>;
	fizin_non_ossedit.lists["x_jenis_pemohon"] = <?php echo $izin_non_oss_edit->jenis_pemohon->Lookup->toClientList($izin_non_oss_edit) ?>;
	fizin_non_ossedit.lists["x_jenis_pemohon"].options = <?php echo JsonEncode($izin_non_oss_edit->jenis_pemohon->options(FALSE, TRUE)) ?>;
	fizin_non_ossedit.lists["x_id_jbu"] = <?php echo $izin_non_oss_edit->id_jbu->Lookup->toClientList($izin_non_oss_edit) ?>;
	fizin_non_ossedit.lists["x_id_jbu"].options = <?php echo JsonEncode($izin_non_oss_edit->id_jbu->lookupOptions()) ?>;
	fizin_non_ossedit.lists["x_id_sektor"] = <?php echo $izin_non_oss_edit->id_sektor->Lookup->toClientList($izin_non_oss_edit) ?>;
	fizin_non_ossedit.lists["x_id_sektor"].options = <?php echo JsonEncode($izin_non_oss_edit->id_sektor->lookupOptions()) ?>;
	fizin_non_ossedit.lists["x_id_subsektor"] = <?php echo $izin_non_oss_edit->id_subsektor->Lookup->toClientList($izin_non_oss_edit) ?>;
	fizin_non_ossedit.lists["x_id_subsektor"].options = <?php echo JsonEncode($izin_non_oss_edit->id_subsektor->lookupOptions()) ?>;
...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="izin_non_oss" data-field="x_id_jenis_izin" data-value-separator="<?php echo $izin_non_oss_edit->id_jenis_izin->displayValueSeparatorAttribute() ?>" id="x_id_jenis_izin" name="x_id_jenis_izin"<?php echo $izin_non_oss_edit->id_jenis_izin->editAttributes() ?>>
			<?php echo $izin_non_oss_edit->id_jenis_izin->selectOptionListHtml("x_id_jenis_izin") ?>
		</select>
</div>
<?php echo $izin_non_oss_edit->id_jenis_izin->Lookup->getParamTag($izin_non_oss_edit, "p_x_id_jenis_izin") ?>
</span>
...
<?php if ($izin_non_oss_edit->jenis_pemohon->Visible) { // jenis_pemohon ?>
	<div id="r_jenis_pemohon" class="form-group row">
		<label id="elh_izin_non_oss_jenis_pemohon" class="<?php echo $izin_non_oss_edit->LeftColumnClass ?>"><?php echo $izin_non_oss_edit->jenis_pemohon->caption() ?><?php echo $izin_non_oss_edit->jenis_pemohon->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<div id="tp_x_jenis_pemohon" class="ew-template"><input type="radio" class="custom-control-input" data-table="izin_non_oss" data-field="x_jenis_pemohon" data-value-separator="<?php echo $izin_non_oss_edit->jenis_pemohon->displayValueSeparatorAttribute() ?>" name="x_jenis_pemohon" id="x_jenis_pemohon" value="{value}"<?php echo $izin_non_oss_edit->jenis_pemohon->editAttributes() ?>></div>
<div id="dsl_x_jenis_pemohon" data-repeatcolumn="5" class="ew-item-list d-none"><div>
<?php echo $izin_non_oss_edit->jenis_pemohon->radioButtonListHtml(FALSE, "x_jenis_pemohon") ?>
</div></div>
</span>
...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="izin_non_oss" data-field="x_id_jbu" data-value-separator="<?php echo $izin_non_oss_edit->id_jbu->displayValueSeparatorAttribute() ?>" id="x_id_jbu" name="x_id_jbu"<?php echo $izin_non_oss_edit->id_jbu->editAttributes() ?>>
			<?php echo $izin_non_oss_edit->id_jbu->selectOptionListHtml("x_id_jbu") ?>
		</select>
</div>
<?php echo $izin_non_oss_edit->id_jbu->Lookup->getParamTag($izin_non_oss_edit, "p_x_id_jbu") ?>
</span>
...
<?php $izin_non_oss_edit->id_sektor->EditAttrs->prepend("onchange", "ew.updateOptions.call(this);"); ?>
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="izin_non_oss" data-field="x_id_sektor" data-value-separator="<?php echo $izin_non_oss_edit->id_sektor->displayValueSeparatorAttribute() ?>" id="x_id_sektor" name="x_id_sektor"<?php echo $izin_non_oss_edit->id_sektor->editAttributes() ?>>
			<?php echo $izin_non_oss_edit->id_sektor->selectOptionListHtml("x_id_sektor") ?>
		</select>
</div>
<?php echo $izin_non_oss_edit->id_sektor->Lookup->getParamTag($izin_non_oss_edit, "p_x_id_sektor") ?>
</span>
...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="izin_non_oss" data-field="x_id_subsektor" data-value-separator="<?php echo $izin_non_oss_edit->id_subsektor->displayValueSeparatorAttribute() ?>" id="x_id_subsektor" name="x_id_subsektor"<?php echo $izin_non_oss_edit->id_subsektor->editAttributes() ?>>
			<?php echo $izin_non_oss_edit->id_subsektor->selectOptionListHtml("x_id_subsektor") ?>
		</select>
</div>
<?php echo $izin_non_oss_edit->id_subsektor->Lookup->getParamTag($izin_non_oss_edit, "p_x_id_subsektor") ?>
</span>
