...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "simpel"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'grB0lkAgDs4c9n9K', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/simpel.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{EC8FDD2A-6757-4E22-9B89-2E852912498C}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "dpmpt.garutkab.go.id", "port" => 3306, "user" => "dpmptgar_peron", "pass" => "Dodolgarut123_", "db" => "dpmptgarutkabgo_simpel"]
	],
